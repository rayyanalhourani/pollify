...
$options = $db->query("SELECT o.id AS option_id,o.option_text,COUNT(v.id) AS vote_count FROM options o LEFT JOIN votes v ON o.id = v.option_id WHERE o.poll_id = :id GROUP BY o.id, o.option_text;", ["id" => $id])->get();
