            ...
            <div class="flex justify-center flex-col">
                ...
                <div id="options">
                    <?php foreach ($options as $option) : ?>
                        <div class="mt-2 flex justify-between items-center" id="option_<?= $option["id"] ?>">
                            <input name="options[]" type="text" value="<?= htmlspecialchars($option["option_text"])?>"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
...
<script>
    let numOfOptions = <?php echo $numOfOptions; ?>;
    ...
    function addOption() {
        ...
        handleAddDeleteOption(numOfOptions,'add')
    }

    function deleteOption(id) {
        document.getElementById("option_" + id).remove();
        handleAddDeleteOption(id,'delete')

    }

    function handleAddDeleteOption(id, action) {
        let div = document.getElementById("AddedAndDeletedIds")
        ...
        if (action === "add") {
            ...
            let added = document.getElementById("added_" + id)
