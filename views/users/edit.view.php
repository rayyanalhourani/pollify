...
<main>
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-sm pb-10">
        <form class="space-y-5 " action="/users/update" method="POST">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="email" name="email" type="text" value='<?= htmlspecialchars($user["email"]); ?>' required
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="cpassword" name="cpassword" type="text" value=''
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
